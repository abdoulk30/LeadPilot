...
from leadpilot.models import contact_history, dedup, leads, run_lock  # noqa: F401

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Use the same settings/.env.local loader the app uses, instead of a
# separate hardcoded URL in alembic.ini — one source of truth.
